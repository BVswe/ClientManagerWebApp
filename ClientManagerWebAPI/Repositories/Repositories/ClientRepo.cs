...
namespace ClientManagerWebAPI.Repositories.Repositories
{
    public class ClientRepo : IClientRepo
    {
        ...
        {
            string query = $"SELECT clients.client_id, first_name, last_name, client_media.client_id, client_media.media_name FROM clients" +
        ...
        {
            string query = $"SELECT first_name, last_name, phone, ts_rank_cd(clients.ts, query) as \"score\"" +
                $" FROM clients, to_tsquery('{searchInput}:*') as query WHERE ts @@ query ORDER BY score DESC;";
            using (var connection = new NpgsqlConnection(_connectionString))
            {
        ...
        public async Task<Client> GetAllInfoSingle(int id)
        {
            string query = "SELECT clients.client_id, first_name, last_name, date, phone, address, email, comments," +
                " client_media.client_id, client_media.media_name, client_media.media_date, client_media.postop," +
